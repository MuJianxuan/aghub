...
const EXCLUDE_DIRS: &[&str] = &["__pycache__", "node_modules", ".git", ".svn", ".hg"];

/// File globs/patterns to exclude.
const EXCLUDE_PATTERNS: &[&str] = &["*.pyc", "*.pyo", "*.class", "*.o", "*.obj"];
...
pub fn read_skill_md(skill_file: &Path) -> Result<String> {
    ...
    let skill_md_path = skill_md_path.ok_or_else(|| SkillError::MissingSkillMd {
